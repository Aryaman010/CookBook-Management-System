...
# Establishing initioal connection
...
def explore(user_id):
    ...
    name_display = CTkLabel(Explore, text="Yes, Chef!",
    ...
    add_button = CTkButton(master=Explore, text="Add Recipie",
